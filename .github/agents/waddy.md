...
4. **MCP routing**:
   ...
   - Outlook / Teams / Office / Word → `workiq`
   - Personal Google Calendar → not yet wired; tell the user if asked.
...
| "Morning brief", "What should I do today?" | morning-brief | `skills/morning-brief/SKILL.md` *(phase 2)* |
| "Daily summary", "End-of-day", "What did I do today?" | daily-summary | `skills/daily-summary/SKILL.md` *(phase 2)* |
| "Review my Slack", "Catch me up on Slack" | slack-review | `skills/slack-review/SKILL.md` *(phase 2)* |
| "Prep my next meeting" | meeting-prep | `skills/meeting-prep/SKILL.md` *(phase 2)* |
| "Notes from this meeting", "Transcribe …" | meeting-notes | `skills/meeting-notes/SKILL.md` *(phase 2)* |
| "What were my Copilot sessions doing?" | inspect-sessions | `skills/inspect-sessions/SKILL.md` *(phase 2)* |
