...
description: >
  ...
  and records a touch on the target task. NO status changes, NO board
  changes. Designed for the rapid context-switching that happens every
  few minutes — between an in-flight Copilot CLI session, Slack, and email.
---
